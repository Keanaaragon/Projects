...
<body>
    ...
    <div class="container text-center">
    	...
    	<p></p>
    	<h2 style="font-family:URW Chancery L, cursive">This site is secure, please log in or if this is your first time here thank you for visiting and please register to join the fun!</h2>
    </div>
    <div class="container">
	 	<h1>Login</h1>
